...
git clone [https://github.com/](https://github.com/)[YourUsername]/gamify-gains.git
cd gamify-gains
...
Create a .env file in the root directory and add your necessary API keys (e.g., Firebase, backend server URLs).
